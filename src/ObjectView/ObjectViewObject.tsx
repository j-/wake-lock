...
const isComplex = (value: any, types: Function[]) => (
  types.some((Type) => value instanceof Type)
);

export const ObjectViewObject: FC<{
  name?: string;
  value: Record<string, any>;
  complexTypes?: Function[];
}> = ({
  value: parent,
  name = parent.__proto__.constructor.name,
  complexTypes = [],
}) => {
        ...
        {keys.map((key, i, arr) => [
          ...
          >
            ...
            {typeof parent[key] === 'function' ? (
              ...
              />
            ) : isComplex(parent[key], complexTypes) ? (
              <ObjectViewComplex value={parent[key]} />
            ) : (
